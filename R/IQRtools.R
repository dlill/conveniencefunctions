...
inspire <- function() {
  cat("Starting a new analysis? Here are some strategies", 
      ...
      "  * Just because there is a script already available, it doesn't mean it's simple",
      "* Overview",
      ...
      "  * Zoom in and out: Actively climb the ladder of abstraction up and down (see Bret Victor's ladder of abstraction)",
      "* Coding",
