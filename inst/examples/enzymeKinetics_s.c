...
void enzymeKinetics_s_initmod(void (* odeparms)(int *, double *)) {
	 int N=32;
	 odeparms(&N, parms);
}

void enzymeKinetics_s_initforc(void (* odeforcs)(int *, double *)) {
	 int N=0;
	 odeforcs(&N, forc);
}

/** Derivatives (ODE system) **/
void enzymeKinetics_s_derivs (int *n, double *t, double *y, double *ydot, double *RPAR, int *IPAR) {
